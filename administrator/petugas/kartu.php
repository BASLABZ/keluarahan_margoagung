...
<div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="row">
                     <div class="col-sm-4">
                     <form method="POST" class="role" action="?pos=kartu">
                                <div class="form-group">
                                    <label>Nama Lengkap</label>
                                ...
                                <div class="form-group">
                                     <button class="submit" name="cari" class="btn btn-primary">Cari</button>
                                </div>
                            </form>
                        </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if (isset($_POST['cari'])) {
                                        $cari = $_POST['cari'];
                                     $sql = " SELECT * from penduduk where nama_lengkap like '%".$cari."%' ";
                                    ...
                                    while ($data = mysql_fetch_row($hasil)) {
                                     ...
                                     ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $data[3]; ?>,Dusun :<?php echo $data[5]; ?> ,
                                                 Desa :<?php echo $data[4]; ?>,Kecamatan : <?php echo $data[6]; ?> ,
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="index.php?pos=edit_penduduk&id_penduduk=<?php echo $data[0]; ?>" class="btn btn-primary">Edit Data</a>
