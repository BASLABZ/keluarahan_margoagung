        ...
        <div class="panel-body invoice">
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <h4 class="invoice-title" style="font-size: 23px;"><span class="fa fa-file"></span> Kartu Keluarga</h4>
                </div>
                <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4"></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-body">
                        ...
                        <p align="left">
                         <img src="images/logogarudas.jpg" width="100" height="100">
                         </p>
