...
<div class="page-heading">
    <h3>
      <span class="fa fa-star"></span>  Tambah data Profil
    </h3>
    <ul class="breadcrumb">
        <li>
            <a href="#">Data</a>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form  class="form-horizontal" method="POST" enctype="multipart/form-data" action="?pos=proses_tambah_profil">
                                    <div class="form-group">
                                       <div class="col-md-12">
                                        <label>Judul</label>
                                        <input type="text" class="form-control" placeholder="Judul Profil" name="judul_profil">
                                       </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
